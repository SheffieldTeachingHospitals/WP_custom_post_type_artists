<?php
/*
Plugin Name: Custom Artist Post Type
Plugin URI: grillopress
Description: A plugin to enable themes to create artists
Version: 0.1
Author: Andrew Duckworth
Author URI: https://github.com/GrilloPress
License: GPL2
*/

// Artist & Musician Post Type
...
function artist_post_type() {
	...
	$args = array(
		...
		'description'           => __( 'Artist or Musician', 'text_domain' ),
		'labels'                => $labels,
    ...
    'rewrite' => array('slug' => 'artists-musicians'),
	);
  
	register_post_type( 'artists-musicians', $args );
